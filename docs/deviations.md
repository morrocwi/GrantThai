...
| "Conflict log" in the output appendix | plan §G listed "the conflict log" | removed; the appendix lists gate records, the source manifest and unresolved references | Nothing in the plan or the package defined what a conflict log contains | `spec/output/nriis-submission.contract.md` |

...
| CX-09 | How many form parts, in what order? | core/02 §9: five (General, Project, Workplan, Utilization, Attachments/Validation) | SD-1 (2566) p15–18: parts 1–5 incl. part 4 entrepreneur information; SD-4 p164 and p166: attachments and a validation page as parts 5 and 6 | Five tabs kept (`NEEDS_VERIFICATION`); entrepreneur information on `UTILIZATION`; validation page not modelled; form profiles deferred to v0.2 |

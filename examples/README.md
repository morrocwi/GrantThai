...
Worked, fully FICTIONAL example projects. Every file in every example carries a FICTIONAL banner, except the committed output copy `demo-seedbank/NRIIS_SUBMISSION.md`, which must stay byte-identical to the build (its project id and every invented value say FICTIONAL or สมมติ). No example combines a real place name with a real institution.

| Example | Ships | What it is |
|---|---|---|

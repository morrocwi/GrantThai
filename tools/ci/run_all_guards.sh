...
run_guard "one-input-one-output (duplicate filename)" tools/ci/check_one_output.py "$ROOT" "$ROOT/tests/fixtures/negative/one_output_dup_filename"
run_guard "one-input-one-output (two templates, one route)" tools/ci/check_one_output.py "$ROOT" "$ROOT/tests/fixtures/negative/one_output_two_templates"
run_guard "one-input-one-output (orphan route_output template)" tools/ci/check_one_output.py "$ROOT" "$ROOT/tests/fixtures/negative/one_output_orphan_template"

...
**โครงสร้างบทความ 7 ส่วน (7SSA)** สำหรับบทความเชิงแนวคิด ทฤษฎี ปรัชญา กฎหมาย การทบทวนเชิงบูรณาการ เชิงรูปนัย SoK หรือเชิงนโยบาย เส้นทาง `academic-article` มีโปรไฟล์โครงสร้างให้เลือกสี่แบบ: `7ssa-world` (เจ็ดหัวข้อภาษาอังกฤษ) `7ssa-thai-7` `7ssa-thai-5` และ `7ssa-thai-4` (หัวข้อภาษาไทยตามเอกสาร 7SSA ของผู้ก่อตั้ง) เนื้อหาแต่ละส่วนเป็นของคุณเอง การรวมเป็น 5 หรือ 4 หัวข้อไม่ลบส่วนใดทิ้ง ทุกส่วนมีเครื่องหมาย [S1]-[S7] กำกับ ระบบเสนอรายชื่อโปรไฟล์ให้ (INFO RT004) แต่ **คุณเป็นคนเลือกเอง** (`routing.structure_profiles` ใน `work.yaml` หรือ `--structure-profile`) และส่งออกเป็น LaTeX ภาษาอังกฤษได้ด้วย `grantthai build --format tex` ตัวอย่างสมมติอยู่ที่ [`examples/article-7ssa-fictional/`](examples/article-7ssa-fictional/)
